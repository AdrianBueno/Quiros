...
/**
 * Created by nardi on 27/10/2016.
 */

public class GestorAudio implements MediaPlayer.OnPreparedListener {
    public static final int SONIDO_VIDA_PERDIDA = 1;
    public static final int SONIDO_ATAQUE_JUGADOR = 2;
    public static final int SONIDO_DISPARO_FLECHA = 3;
